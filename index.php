...
<html>
  ...
  <body class="login-page bg-login">
    <div class="login-box">
      <a href="index.php">
        <div style="color:#4289DB" class="login-logo">
          <img style="margin-top:-12px" src="imagenes/COBI_AZUL.png" alt="Logo" height="100">
        </div>
      </a>
      <br>
      <br>
      ...
      <div class="login-box-body">
        ...
        <form action="login-check.php" method="POST">
          <div class="form-group has-feedback">
            <input type="text" class="form-control" name="username_login" id="username_login" placeholder="Username" autocomplete="off" required="" autofocus="" />
