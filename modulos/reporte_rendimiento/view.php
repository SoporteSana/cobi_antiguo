...
<section class="content-header">
  <h1>
    <i class="fas fa-chart-line"></i> Reporte de rendimiento
  </h1>
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        <!-- form start -->
        <form role="form" class="form-horizontal" method="POST" action="?modulo=form_reporte_rendimiento" target="_blank">
          <div class="box-body">
