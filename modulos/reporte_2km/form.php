<section class="content-header">
  <h1>
    <i class="fas fa-tachometer-alt"></i> Resultados de 2km/lt
  </h1>
...
?>
          ...
          <table id="tabla_reporte_2km" class="table table-bordered table-striped table-hover">
