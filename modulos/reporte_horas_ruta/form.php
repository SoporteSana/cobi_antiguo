<section class="content-header">
  <h1>
    <i class="fas fa-business-time"></i> Resultados de horas-ruta.
  </h1>
...
<?php
  ...
  $unidad_ID_busqueda       = $_POST['unidad_ID_horas_ruta_busqueda'];
  ...
  if (isset($_POST['fecha_uno_busqueda'])) {
      ...
      $query = mysqli_query($mysqli, "SELECT
                                            ...
                                            ROUND((cat_registros.total_peso/1000),2) AS total_toneladas,
                                        ...
                                        WHERE
                                            ...
                                            AND(
                                                  cat_registros.tiempo_ruta >= '12:00:00'
                                              ) AND(
                                                  cat_registros.total_peso >= '21000')
                                                  AND
...
?>
          ...
          <table id="tabla_reporte_horas_ruta" class="table table-bordered table-striped table-hover">
