...
<section class="content-header">
  <h1>
    <i class="fas fa-business-time"></i> Reporte horas-ruta
  </h1>
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        <!-- form start -->
        <form role="form" class="form-horizontal" method="POST" action="?modulo=form_reporte_horas_ruta" target="_blank">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="hidden" class="form-control" name="unidad_ID_horas_ruta_busqueda" id="unidad_ID_horas_ruta_busqueda" autocomplete="off" >
                <input type="text" class="form-control" name="unidad_horas_ruta_busqueda" id="unidad_horas_ruta_busqueda" autocomplete="off">
              </div>
            </div>
