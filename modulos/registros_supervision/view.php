...
<section class="content-header">
  <h1>
    <i class="far fa-clipboard"></i> Supervisión - Gestión de registros del día: <?php date_default_timezone_set('America/Mexico_City'); echo date('d-m-Y'); ?>
  </h1>
    ...
    <br>
      <div class="box box-primary">
        <div class="box-body">
          ...
          <table id="tabla_registros_supervision" class="table table-bordered table-striped table-hover">
            ...
            <thead>
              <tr>
                ...
                <th class="center">Completar información</th>
              </tr>
            </thead>
            ...
            $query = mysqli_query($mysqli, "SELECT
                                            ...
                                            WHERE cat_estatus_registro.estatus_ID = '2'
                                            ORDER BY
            ...
            while ($data = mysqli_fetch_assoc($query)) { 
              ...
              echo "  <td class='center'>$data[unidad]</td>
                      ...
                      <td class='center'>$data[estatus] <i class='text-info far fa-calendar-check'></i></td>

                      <td class='center' width='100'>
                          <div>";

              echo "      <a data-toggle='tooltip' data-placement='top' class='btn btn-info btn-sm' href='?modulo=form_registros_supervision&form=edit&id=$data[registro_ID]'>
                                <i style='color:#fff'; class='fas fa-list-ul'></i>
                            </a>
                          </div>
                      </td>
                    </tr>";
